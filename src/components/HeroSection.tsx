    ...
    <section id="home" className="relative h-screen overflow-hidden">
      ...
      <div className="relative z-10 h-full flex items-center justify-center text-center text-cream">
        <div className="section-padding max-w-6xl">
          <div className="mb-8">
            <p className="text-lg md:text-xl text-cream/80 tracking-widest mb-4 animate-fade-in-up">
              A PRIVATE ESTATE FOR SALE
            </p>
          </div>
          
          <h1 className="text-5xl md:text-7xl lg:text-8xl font-light tracking-wider mb-8 animate-fade-in-up" style={{ animationDelay: '0.2s' }}>
            ROTAS
            <span className="block text-terracotta font-normal mt-2">ESTATE</span>
          </h1>
          
          <p className="text-lg md:text-xl lg:text-2xl font-light tracking-wide mb-12 max-w-4xl mx-auto opacity-90 animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
